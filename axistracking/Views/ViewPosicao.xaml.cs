...
{
    public partial class ViewPosicao : ContentPage, IViewPosicao
    {
        ...
        public ViewPosicao(PainelDto Painel, object obj, EnumPage Page)
        {
            InitializeComponent();
        ...
        )
        {
            ...
            //_viewModelPosicao.PainelDetalhesHeightRequest = 100;
            ...
            /*if (e.PropertyName != null)
            {
                ...
                {
                    if ((StackLayout)sender != null)
                    {
                        if (Convert.ToInt32(((StackLayout)sender).Height) > 0)
